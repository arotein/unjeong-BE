...
//                .body(CommonResponse.builder().errorCode(1).errorMessage(ex.getMessage()).build());
//    }
    ...
    public ResponseEntity methodNotAllowedExHandle(HttpRequestMethodNotSupportedException ex) {
        ...
        return ResponseEntity.status(HttpStatus.METHOD_NOT_ALLOWED)
                .body(CommonResponse.builder().errorCode(2).errorMessage(ex.getMessage()).build());
    }
    ...
    public ResponseEntity constraintViolationExHandle(ConstraintViolationException ex) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(CommonResponse.builder().errorCode(4).errorMessage(ex.getMessage()).build());
    }
